        ...
        <div className="hero-gradient py-20 md:py-32">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              >
                Access thousands of expert-led courses in programming, design,
                business, and more. Start your learning journey today.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-muted-foreground mb-8 text-lg">
                We provide world-class education accessible to everyone. Our
                platform is designed to help you succeed with practical,
                real-world skills.
              </p>
              ...
              <Link to="/signup">
                <Button
                  size="lg"
                  className="mt-8 hero-gradient text-primary-foreground hover:opacity-90"
                >
                  Get Started Free
                </Button>
              </Link>
